...
namespace LMS.Infrastructure.Migrations
{
    ...
    [Migration("20250925190455_InheritIdentityTables")]
    partial class InheritIdentityTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Activity", b =>
                {
                    ...
                    b.HasIndex("CourseModuleId", "StartDate");

                    b.ToTable("Activity", null, t =>
                        {
                            t.HasCheckConstraint("CK_Activity_StartBeforeEnd", "StartDate < EndDate");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Entities.CourseModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ApplicationUserRole", b =>
                {
                    b.HasOne("Domain.Models.Entities.ApplicationRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Domain.Models.Entities.Activity", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Entities.CourseModule", "CourseModule")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Domain.Models.Entities.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
