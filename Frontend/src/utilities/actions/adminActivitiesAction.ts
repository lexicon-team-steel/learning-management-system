...
const validateActivity = (formData: FormData): FormErrorType => {
...
export const adminActivitiesAction = adminEntityAction({
  entity: 'activity',
  validate: validateActivity,
  apiURL: `${BASE_URL}/admin/activity`,
  redirectURL: '/admin/activity',
});
